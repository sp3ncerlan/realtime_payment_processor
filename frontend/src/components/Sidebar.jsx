        ...
        <div className="flex h-screen w-64 flex-col justify-between border-e border-gray-800 bg-gray-900">
            <div className="px-4 py-6">
                ...
                <li>
                    ...
                    <summary className="flex cursor-pointer items-center justify-between rounded-lg px-4 py-2 text-gray-400 hover:bg-gray-800 hover:text-gray-100">
                ...
                <li>
                    ...
                    <ul className="mt-2 space-y-1 px-4">
                        ...
                        <li>
                        <a href="#" className="w-full rounded-lg px-4 py-2 [text-align:_inherit] text-sm font-medium text-gray-400 hover:bg-gray-800 hover:text-gray-100">
                            Logout
                        </a>
                        </li>
                    </ul>
            ...
            <div className="sticky inset-x-0 bottom-0 border-t border-gray-800">
                <a href="#" className="flex items-center gap-2 bg-gray-900 p-4 hover:bg-gray-800">

                <div>
                    <p className="text-xs">
                    <strong className="block font-medium text-gray-100">Eric Frusciante</strong>
